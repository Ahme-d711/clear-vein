...
const defaultIcons = [
  <Activity key="1" className="w-8 h-8 text-[#0084a9]" />,
  <Stethoscope key="2" className="w-8 h-8 text-[#0084a9]" />,
  <Zap key="3" className="w-8 h-8 text-[#0084a9]" />,
  <RotateCcw key="4" className="w-8 h-8 text-[#0084a9]" />,
  <PlusSquare key="5" className="w-8 h-8 text-[#0084a9]" />,
];

export default function ConditionsWeTreat({ title, description, conditions = [] }: ConditionsWeTreatProps) {
    return (
