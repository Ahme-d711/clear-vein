...
export default function ServicesOverview({ services, title, description1, description2 }: ServicesOverviewProps) {
    return (
                ...
                <div className="grid grid-cols-1 lg:grid-cols-5 gap-12 lg:gap-24 items-start">
                    ...
                    <div className="space-y-8 lg:col-span-3">
                        ...
                        <Fade direction="up" triggerOnce delay={400} duration={800}>
                            <p className="text-base md:text-lg leading-relaxed font-light max-w-2xl whitespace-pre-line">
                                {description2}
                            </p>
                        </Fade>
                    </div>
