...
const treatments = [
    ...
    {
        title: "EVLT",
        subtitle: "Endovenous Laser Treatment",
    ...
    },
    {
        ...
        subtitle: "Chemical Sclerotherapy",
                            ...
                            >
                                <div className="space-y-8 h-full flex flex-col justify-between">
                                    <div className="space-y-6">
                                        {/* Accent Bar */}
                                        <div className="h-1 w-12 bg-white/40 group-hover:bg-white transition-colors duration-300" />
